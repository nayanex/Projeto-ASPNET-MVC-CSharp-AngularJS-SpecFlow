...
Para que eu possa informar ao time de desenvolvimento a meta do ciclo, de forma que as entregas agreguem valor ao negócio da minha empresa.", ProgrammingLanguage.CSharp, new string[] {
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "O Gestor do Produto definir as entregas de um ciclo de desenvolvimento")))
            {
                WexProject.Test.Features.OGestorDoProdutoDefinirAsEntregasDeUmCicloDeDesenvolvimentoFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("[BUG] - Um colaborador troca o status de uma estória de pronto para replanejado")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "O Gestor do Produto definir as entregas de um ciclo de desenvolvimento")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("pbi_3.1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("rf_4.02")]
