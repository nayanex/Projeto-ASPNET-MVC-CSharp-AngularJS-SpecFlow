...
public partial class SelectImageForm : HtmlEditorUserControl
{
    ...
    /// <param name="e">FileManagerFolderCreateEventArgs e</param>
    ...
    /// </summary>
    /// <param name="sender">sender</param>
    /// <param name="e">FileManagerItemDeleteEventArgs e</param>
    ...
    /// </summary>
    /// <param name="sender">sender</param>
    /// <param name="e">FileManagerItemMoveEventArgs e</param>
    ...
    /// </summary>
    /// <param name="sender">sender</param>
    /// <param name="e">FileManagerItemRenameEventArgs e</param>
    ...
    /// </summary>
    /// <param name="sender">sender</param>
    /// <param name="e">FileManagerFileUploadEventArgs e</param>
    ...
    /// </summary>
    /// <param name="sender">sender</param>
    /// <param name="e">DevExpress.Web.ASPxClasses.CustomJSPropertiesEventArgs e</param>
