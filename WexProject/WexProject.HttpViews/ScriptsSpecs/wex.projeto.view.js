...
/// <reference path="~/Scripts/wex.projeto.config.js" />
/// <reference path="~/Scripts/wex.projeto.resource.js" />
/// <reference path="~/Scripts/wex.projeto.view.js" />
...
describe("wex.projeto.view.js", function() {
    ...
    it("deve estar definido WEX.Projeto.ProjetoDTO", function() {
        expect(WEX.Projeto.ProjetoDTO).toBeDefined();
    });
    ...
    describe("Modulo projeto.view", function () {
        ...
        beforeEach(module("wex.service"));
        beforeEach(module("projeto.view"));
